  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        <h2 className="text-2xl font-bold mb-4">Text to Audio</h2>
      ...
      <div className="p-4">
        <div className="max-w-2xl mx-auto rounded-3xl border border-gray-300 bg-white px-4 py-3 shadow-sm">
          <textarea
            value={text}
            onChange={(e) => setText(e.target.value)}
            placeholder="Enter text in English — it will be translated to Hindi..."
            rows={2}
          ...
          <div className="flex gap-2 items-center mt-1">
            ...
            <button
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded-full text-sm disabled:opacity-50 ml-auto"
            >
